...
public class InputProgramGenerator {
	 ...
	 * 
	 */
	public Program generateUnifiedSmallBankProgram(String... args) {
		/*
		 * 
		 * Tables
		 * 
		...
		if (txns.contains("TransactSavings")) {
			...
			Update_Query TransactSavings_U1 = pu.addUpdateQuery("TransactSavings", "accounts", true,
					TransactSavings_U1_WHC);
			TransactSavings_U1.addUpdateExp(pu.getFieldName("savings"),
					new E_BinUp(BinOp.MINUS, pu.getProjExpr("TransactSavings", 0, "savings", 1), pu.getArg("ts_amount")));
			pu.addQueryStatementInIf("TransactSavings", 0, TransactSavings_U1);
		}
		/*
		 * 
	 ...
	 * 
	 */
	public Program generateCRDTSmallBankProgram(String... args) {
		/*
		 * 
		 * Tables
		 * 
