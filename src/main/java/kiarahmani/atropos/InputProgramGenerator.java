	...
	public Program generateSmallBankProgram(String... args) {
		...
		if (txns.contains("Balance")) {
			...
			WHC Balance_GetAccount0_WHC = new WHC(new WHC_Constraint(pu.getTableName("accounts"),
					pu.getFieldName("a_name"), BinOp.EQ, pu.getArg("ba_custName")));
			...
			WHC Balance_GetSavings_WHC = new WHC(new WHC_Constraint(pu.getTableName("savings"),
					pu.getFieldName("s_custid"), BinOp.EQ, pu.getProjExpr("Balance", 0, "a_custid", 1)));
		...
		if (txns.contains("DepositChecking")) {
			...
			WHC DepositChecking_WHC = new WHC(new WHC_Constraint(pu.getTableName("checking"),
					pu.getFieldName("c_custid"), BinOp.EQ, pu.getProjExpr("DepositChecking", 0, "a_custid", 1)));
		...
		if (txns.contains("SendPayment")) {
			...
			WHC SendPayment_U1_WHC = new WHC(new WHC_Constraint(pu.getTableName("checking"),
					pu.getFieldName("c_custid"), BinOp.EQ, pu.getArg("sp_sendAcct")));
		...
		if (txns.contains("TransactSavings")) {
			...
			WHC TransactSavings_U1_WHC = new WHC(new WHC_Constraint(pu.getTableName("savings"),
					pu.getFieldName("s_custid"), BinOp.EQ, pu.getProjExpr("TransactSavings", 0, "a_custid", 1)));
