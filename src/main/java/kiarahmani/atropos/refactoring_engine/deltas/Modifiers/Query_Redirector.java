...
public class Query_Redirector extends Query_Modifier {
	...
	public Query modify_single(Query input_query) {
		...
		Select_Query q = new Select_Query(-1, pu.getNewSelectId(txnName), true, pu.getTableName("accounts"), fns, v, GetAccount0_WHC);
		return q;
